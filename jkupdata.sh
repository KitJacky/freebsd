...
fetch http://jkzone.net/download/file/$CVSFILE >/dev/null 2>&1 >> $LOGFILE
...
fetch http://jkzone.net/download/file/$PORTSFILE >/dev/null 2>&1 >> $LOGFILE
