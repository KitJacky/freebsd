...
FileA="JKFreeBSDupdata-1.4_12012010.sh"
FileB="jkupdate.sh"
...
echo "your FreeBSD Version is ? $Version" >> $LOGFILE
...
echo
echo "   Check the log, Sure no problem TYPE $FileB {kconfig 4|5|6|7|8}"
echo
...
echo -e "\\033[1;33m"your Server Hostname is ? $HOSTNAME"\\033[0;39m"
       ...
       echo "  {4|5|6|7|8} your freebsd version. ( $Version )"
       echo
